...
def main():
    ...
    with st.container():
        left_column, _ = st.columns([2, 1])  # Adjust column widths as needed
        with left_column:
            st.header("What it actually is??")
    ...
    with st.container():
        ...
        st.image(image, caption='Image Generated by AI (deepai.org)', width=800, use_column_width=True)
