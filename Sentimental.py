...
def main():
    st.set_page_config(page_title="LIVE Tweets Sentimental Analysis", layout="wide", initial_sidebar_state="expanded")
    ...
    with st.container():
        ...
        st.image(image, caption='Image Generated by AI (deepai.org)', width=800)
